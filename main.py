...
sfr = SimpleFacerec()
sfr.load_encoding_images("C:/xampp/htdocs/vistagrade/system/pages/student/images/")
...
def process_frame(frame, subject, teacher, timeinout):
    ...
    for face_loc, name in zip(face_locations, face_names):
        ...
        select_query = f"SELECT * FROM tblstudentclass WHERE studentid = '{studentid}' AND subjectid = '{subject}' AND teacherid = '{teacher}'"
        cursor.execute(select_query)
        rows = cursor.fetchall()
